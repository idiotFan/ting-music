...
0.8.0 的审查修复继续保留，0.9.0 将 QQ 与下载迁到 Rust 并增加 iOS 真机构建。完整范围和验证边界见 [审查记录](docs/REVIEW.md) 与 [验证历史](docs/VALIDATION.md)。当前仍未完成公开商店发行（各平台均为开发 / 体验级签名）、自动更新、Developer ID 公证和本机数据迁移工具。
